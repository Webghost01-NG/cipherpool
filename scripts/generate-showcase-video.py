...
NARRATION = [
    ...
    "This is not a simulated transaction. A real one c U S D C deposit and direct withdrawal completed on Sepolia, restoring the test wallet to ten c U S D C. A later encrypted one c U S D C sponsor contribution funded the reserve. The receipts and authorized K M S evidence are linked in the repository.",
